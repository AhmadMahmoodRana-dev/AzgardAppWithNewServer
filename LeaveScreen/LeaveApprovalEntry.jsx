...
//     try {
//       setLoading(true);
//       const response = await fetch(`https://hcm.azgard9.com/ords/api/az/get?SUP_ID=${global.xx_emp_id}`);
//       const data = await response.json();
//       setLeaveRequests(data.leave_approval);
//     } catch (error) {
//       // Alert.alert('Error', 'Failed to fetch leave requests');
...
// ///console.log(global.xx_supervisor_id);

//   const approveRequest = async (id,TYPE) => {
//     try {
//      setLoading(true);
//      const L_STATUS='APPROVED'
//       const response = await fetch(`https://hcm.azgard9.com/ords/api/api/update?LEAVE_ID=${id}&L_TYPE=${TYPE}&L_STATUS=${L_STATUS}&USER_ID=${global.xx_user_id}`, {
//         method: 'PUT',
//         headers: {
//           'Content-Type': 'application/json',
//         },
...
//   const rejectRequest = async (id,TYPE) => {
//     try {
//       setLoading(true);
...
//       <Text style={styles.text}>Reason: {item.REMARKS}</Text>
//       <Text style={styles.text}>
//         From:{formatDate(item.FROM_DATE)} To:{formatDate(item.TO_DATE)} {item.LEAVE_TYPE === 'Short Leave' || item.LEAVE_TYPE === 'Out Door Duty' ? 'Hours: ' : 'Days:'}
// {item.NO_OF_DAYS}
//       </Text>
//       <View style={styles.buttonContainer}>
//         <TouchableOpacity
//           style={styles.buttonApprove}
//           onPress={() => approveRequest(item.EMP_LEAVE_ID,item.TYPE)}
//         >
//           <Text style={styles.buttonText}>Approve</Text>
//         </TouchableOpacity>
//         <TouchableOpacity
//           style={styles.buttonReject}
//           onPress={() => rejectRequest(item.EMP_LEAVE_ID,item.TYPE)}
//         >
...
//   buttonApprove: { backgroundColor: '#28a745', padding: 10, borderRadius: 5, alignItems: 'center', flex: 1, marginRight: 5 },
//   buttonReject: { backgroundColor: '#dc3545', padding: 10, borderRadius: 5, alignItems: 'center', flex: 1, marginLeft: 5 },
//   buttonText: { color: '#fff', fontWeight: 'bold' },
//   center: { flex: 1, justifyContent: 'center', alignItems: 'center' },
//   emptyText: { textAlign: 'center', fontSize: 16, color: '#fff' },
// });
