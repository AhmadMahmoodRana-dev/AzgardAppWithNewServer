...
const CasualLeave = () => {
  ...
  const data = [
    ...
    {label: 'Half Casual Leave', value: '4'},
  ];
      ...
      <SafeAreaView>
        <ScrollView contentContainerStyle={{flexGrow: 1}}>
          ...
          <View style={styles.container}>
           ...
           size={90}
           width={10}
           fill={item.BALANCE_MEDICAL_VALUE}
           tintColor="#C70000"
           backgroundColor="#3498DB">
            {fill => (
    <Text style={styles.progressText}>
              ...
              leavHistory
                .filter(
                  item =>
                    ...
                    item.LEAVE_TYPE === 'Half Casual Leave',
                )
                .map(item => (
                  <View
...
//     size={90}
//     width={10}
//     fill={50} // Progress in percentage
//     tintColor="#3498DB"
...
//     )}
//   </AnimatedCircularProgress>
//   <Text style={styles.leaveType}>Vacation Leave</Text>
//   <Text style={styles.leaveCount}>3/6</Text>
// </View>
...
//             size={90}
//             width={10}
//             fill={75} // Progress in percentage
//             tintColor="#2ECC71"
//             backgroundColor="#E8F6FF"
//           />
//           <Text style={styles.leaveType}>Medical Leave</Text>
//           <Text style={styles.leaveCount}>6/8</Text>
//         </View>
...
//           <Text style={styles.leaveCount}>4/6</Text>
//         </View>
//       </View>
