...
const SpecialLeave = () => {
  ...
  const data = [
    {label: 'Special Leave', value: '12'},
    {label: 'Half Special Leave', value: '31'},
  ];
  ...
  //   }
  //     try {
  //         const response = await axios.post('https://hcm.azgard9.com/ords/api/leave/insertLeave', formData, {
  //             headers: {
  //                 'Content-Type': 'multipart/form-data',
  //             },
  //         });
        ...
        <Text style={[styles.cell, styles.greenCell]}>{item.TOTAL_BALANCE_VALUE}</Text>
            ...
            <View style={styles.containerdropdown}>
              ...
              {loading ? (
                ...
                leavHistory
                  .filter(item => item.LEAVE_TYPE === 'Special Leave')
                  .map(item => (
                    <View
